        ...
        <Popover className="relative bg-white">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
                <div className="flex border-b-2 border-gray-100 ">
                    ...
                    {/* <div className="flex flex-auto w-72 content-between items-center"> */}

                    {/* <div className="flex flex-auto w-72 align-content: space-between; items-center"> */}
                    {/* <div className="basis-1/2"><SearchBar /></div>
                        <div>
                            <div className="basis-1/2"> <DiscountSlider onSliderChange={onSliderChange} /></div>
                            <div className="basis-1/2"><Dropdown /></div>
                        </div> */}
